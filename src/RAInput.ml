...
RALetExp ("slot_assignment",  RARenameCol("port.port_id", "port_id",
  ...
  RAUnionWithDifferentSchema(RAUnionWithDifferentSchema(RATable "slot_assignment", RARenameCol ("arrival", "rp.arrival", RARenameCol ("port_id", "rp.port_id", RATable "reachable_ports"))), RARenameCol ("port_id", "fp.port_id", RATable "feasible_ports"))
)))))));;
